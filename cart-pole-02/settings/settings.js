...
function buildSettings()
{
    ...
    // Value model
    html += "<br/><br/>";
    html += "<h1>Value model</h1>";
    html += "Number of epochs:";
    html += "<input type='text' style='position:absolute;right:0px;' id='settings.valuemodel.epochs' value='" + g_settings.valuemodel.epochs + "'/><br/>";
    html += "Number of layers:";
    html += "<input type='text' style='position:absolute;right:0px;' id='settings.valuemodel.layers' value='" + g_settings.valuemodel.layers + "'/><br/>";
    html += "Number of units per layer:";
    html += "<input type='text' style='position:absolute;right:0px;' id='settings.valuemodel.units' value='" + g_settings.valuemodel.units + "'/><br/>";
    html += "Learning rate:";
    html += "<input type='text' style='position:absolute;right:0px;' id='settings.valuemodel.learningRate' value='" + g_settings.valuemodel.learningRate + "'/><br/>";
    html += "Mini batch-size:";
    html += "<input type='text' style='position:absolute;right:0px;' id='settings.valuemodel.miniBatchSize' value='" + g_settings.valuemodel.miniBatchSize + "'/><br/>";
    html += "<br/><br/>";
...
function saveSettings()
{
    ...
    try
    {
        ...
        g_settings.valuemodel.units = getElementValue("settings.valuemodel.units", parseInt, 1, true, 65535, true);
        g_settings.valuemodel.learningRate = getElementValue("settings.valuemodel.learningRate", parseFloat, 0.0, false, 1.0, true);
        g_settings.valuemodel.miniBatchSize = getElementValue("settings.valuemodel.miniBatchSize", parseInt, 1, true, 65535, true);
